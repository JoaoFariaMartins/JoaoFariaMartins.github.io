...
\UseAllTwocells
\MathJaxFilename{lwarp-with-Xy-jax_v6.txt}
...
\date{Last modified: May 25, 2024}
\maketitle
...
\begin{itemize}
   ...
   \item Configuration file required for browsers to find Xy-Jaxv6,
\href{lwarp-with-Xy-jax_v6.txt}{lwarp-with-Xy-jax\_v6.txt}. This script is essentially the original Lwarp MathJax emulation code, \href{lwarp_mathjax.txt}{lwarp\_mathjax.txt}  (automatically created by  lwarp v0.902), with two minimal additions, as shown. File tweaked 25May2026. Requires \href{https://raw.githubusercontent.com/sonoisa/XyJax-v3/master/build/xypic.js}{xypic.js} in directory ``js''.
\end{itemize}
...
\begin{center}
\href{lwarp-with-Xy-jax_v6.txt}{lwarp-with-Xy-jax\_v6.txt}.
\end{center}
...
\begin{verbatim}
  ...
  \MathJaxFilename{lwarp-with-Xy-jax_v6.txt}
\end{verbatim}
Also create a directory ``js'', and copy the file  \href{https://raw.githubusercontent.com/sonoisa/XyJax-v3/master/build/xypic.js}{xypic.js} to it.
...
\begin{verbatim}
 \MathJaxFilename{lwarp-with-Xy-jax_v6.txt}
\end{verbatim}
You will also need this configuration file: \href{lwarp-with-Xy-jax_v6.txt}{lwarp-with-Xy-jax\_v6.txt}.
(Explanation is in Section \ref{Context}. Also requires \href{https://raw.githubusercontent.com/sonoisa/XyJax-v3/master/build/xypic.js}{xypic.js} in directory ``js'')
